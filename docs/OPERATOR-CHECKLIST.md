...
| 1.3 | (Optional) Rename the GitHub repository | Owner's choice — currently `https://github.com/junkpro518/z`; renaming is one click in repo Settings and GitHub auto-redirects old clones | ☐ |
